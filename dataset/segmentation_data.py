...
'''
img_dir_train_dir = '/backup/RGB-D/SUNRGBD/train/images'
depth_dir_train_dir = '/backup/RGB-D/SUNRGBD/train/depths'
label_dir_train_dir = '/backup/RGB-D/SUNRGBD/train/labels'

img_dir_test_dir = '/backup/RGB-D/SUNRGBD/test/images'
depth_dir_test_dir = '/backup/RGB-D/SUNRGBD/test/depths'
label_dir_test_dir = '/backup/RGB-D/SUNRGBD/test/labels'
'''
img_dir_train_dir = '/backup/RGB-D/NYUv2/train/images'
depth_dir_train_dir = '/backup/RGB-D/NYUv2/train/depths'
label_dir_train_dir = '/backup/RGB-D/NYUv2/train/labels'

img_dir_test_dir = '/backup/RGB-D/NYUv2/test/images'
depth_dir_test_dir = '/backup/RGB-D/NYUv2/test/depths'
label_dir_test_dir = '/backup/RGB-D/NYUv2/test/labels'
...
class NYUv2(Dataset):
    def __init__(self, transform=None, phase_train=True, data_dir=None):
        ...
        self.img_dir_train = sorted(glob.glob(img_dir_train_dir+'/*'))
        self.depth_dir_train = sorted(glob.glob(depth_dir_train_dir+'/*'))
        self.label_dir_train = sorted(glob.glob(label_dir_train_dir+'/*'))
        
        self.img_dir_test = sorted(glob.glob(img_dir_test_dir+'/*'))
        self.depth_dir_test = sorted(glob.glob(depth_dir_test_dir+'/*'))
        self.label_dir_test = sorted(glob.glob(label_dir_test_dir+'/*'))
    ...
    def __getitem__(self, idx):
        ...
        label = sio.loadmat(label_dir[idx])['segmentation']
        #label = imageio.imread(label_dir[idx])
